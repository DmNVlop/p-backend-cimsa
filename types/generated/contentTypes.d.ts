...
export interface ApiMaterialMaterial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    veta: Schema.Attribute.Enumeration<['L', 'A']>;
  };
}
...
export interface ApiPiezaPieza extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cantoL2: Schema.Attribute.Relation<'oneToOne', 'api::canto.canto'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    largo: Schema.Attribute.Decimal &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::canto.canto': ApiCantoCanto;
      'api::material.material': ApiMaterialMaterial;
      'api::pedido.pedido': ApiPedidoPedido;
      'api::pieza.pieza': ApiPiezaPieza;
